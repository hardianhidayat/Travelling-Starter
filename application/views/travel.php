            ...
            <?php foreach($tempat as $tpt) : ?>
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="<?= base_url('assets/img/destination/') . $tpt['gambar'] ?>" alt="Gambar destinasi" width="700" height="250">
                        </div>
                        <div class="content">
    ...
    <div class="popular_places_area">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        <h3>Tempat Destinasi Terpopuler</h3>
                        <p>Menjelajah Menghasilkan Seni, Seni Tak Memiliki Nilai, Nilai Bukan Hanya Sebuah Angka Akan Setapi Sebuah Identitas.</p>
                    </div>
                </div>
            </div>
                ...
                <?php foreach($travel as $trv) : ?>
                    <div class="col-lg-4 col-md-6">
                        <div class="single_place">
                            <div class="thumb">
                                <img src="<?= base_url('assets/img/place/') . $trv['gambar'] ?>" alt="" width="700" height="250">
                ...
                <div class="col-lg-12">
                    <div class="video_wrap text-center">
                        ...
                        <div class="video_icon">
                            <a class="popup-video video_play_button" href="https://www.youtube.com/watch?v=OIfEp2a4vTI">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        <div class="icon">
                            <img src="<?= base_url('assets/') ?>img/svg_icon/ppl.svg" alt="">
                        </div>
        ...
        <div class="container">
            ...
            <?php foreach($guide as $gd) : ?>
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="<?= base_url('assets/img/place/') . $gd['gambar'] ?>" alt="Gambar destinasi" width="700" height="250">
                            <a href="#" class="prise" ><?= $gd['rating'] ?></a>
                        </div>
                        <div class="place_info">
                                <h3><?= $gd['nama'] ?></h3>
                                <p><?= $gd['no_telp'] ?></p>
