                ...
                <div class="col-lg-8 col-md-9">
                    ...
                    <!-- <div class="contact_join"> -->
                        <form action="<?= base_url('travel/checkout') ?>" method="post">
                            ...
                            <div class="row">                                
                                <div class="col-lg-12 m-auto col-md-6 text-center">
                            ...
                            <input type="hidden" id="session" value="<?= $this->session->user; ?>">
                             <div class="row hTanggal">
                                ...
                                <div class="col-lg-6 mt-4 mb-4"> 
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Pilih Tanggal" name="pilihtanggal" id="pilihtanggal" autocomplete="off">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2"><i class="fa fa-calendar"></i></span>
                                        </div>
                                    </div>
                            ...
                            <div class="plengkap">
                                ...
                                <?php else : ?>
                                    ...
                                    <div class="lengkapah">
                                        <label class="mt-10">Total Orang</label>
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="custom-select jenisTransport" name="jenis_transport">
                                                <option selected value="0">Berapa Orang</option>
                                                <option value="Udara">1-3</option>
                                                <option value="Laut">4-6</option>
                                                <option value="Darat">>6 
                                                </option>
                                            </select>
                                        </div>
                                        <div class="mt-3"></div>  
                                        <small><i>*Jika lebih dari 6, maka akan kena charge saat tour</i></small><br class="mb-3">
                                        <!-- <label class="mt-10">Total Bayar</label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                            ...
                                            <select class="custom-select transports" name="transportasi">
                                                <option selected value="0">150.000</option>
                                            </select>
                                        </div>
                                        <div class="mt-3"></div>
